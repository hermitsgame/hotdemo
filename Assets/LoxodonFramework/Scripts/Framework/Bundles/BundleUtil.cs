...
namespace Loxodon.Framework.Bundles
{
    public class BundleUtil
    {
        ...
        /// <param name="bundleInfo"></param>
        /// <returns></returns>
		public static bool ExistsInStorableDirectory(BundleInfo bundleInfo, string module = "")
        {
			var path = module.Length > 0 ? module + "/" + bundleInfo.Filename : bundleInfo.Filename;
            return ExistsInStorableDirectory(path);
        }
        ...
        /// <param name="bundleInfo"></param>
        /// <returns></returns>
		public static bool Exists(BundleInfo bundleInfo, string module = "")
        {
            ...
            if (ExistsInStorableDirectory(bundleInfo, module))
                return true;
