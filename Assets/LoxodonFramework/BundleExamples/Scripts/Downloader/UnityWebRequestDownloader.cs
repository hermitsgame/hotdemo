...
namespace Loxodon.Framework.Examples.Bundle
{
    public class UnityWebRequestDownloader : AbstractDownloader
    {
		...
		public UnityWebRequestDownloader(Uri baseUri, string module = "") : this(baseUri, SystemInfo.processorCount * 2, module)
        {
        }

		public UnityWebRequestDownloader(Uri baseUri, int maxTaskCount, string module) : base(baseUri, maxTaskCount, module)
        {
        }
